...
/** Rejects anything but a real YYYY-MM-DD date — the same format AntD's DatePicker submits everywhere else in this app. */
 ...
 * its API enforce: a real date, and no two holidays sharing a date.
 */
export function validateHolidayImportRows(
  rawRows: Record<string, string>[],
  context: { existingHolidays: Holiday[] }
): HolidayImportRowResult[] {
